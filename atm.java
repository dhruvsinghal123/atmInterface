        ...
        while (b) {
            ...
            brea: {
                ...
                if (choice == 1) {
                    ...
                    File file = new File(FilePath + username + ".txt");// new file is created in current directory with
                                                                       // username.txt
                    if (file.exists()) {
                    ...
                    regLogin reg = new regLogin(name, username, password, number, "TRANSACTION:0", FilePath);
                    reg.message();
